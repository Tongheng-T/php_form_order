...
session_start();
  ...
  $connect = mysqli_connect("localhost","root","","ulogin");
  			...
  			<div class= col-md-6>
				...
				<?php
  				...
  				while ($row = mysqli_fetch_array($result)) { ?>
  					...
  					<div class="col-md-3">
  					<form method="post" action="tes.php?id=<?=$row['id'] ?>">
           ...
           if (!empty($_SESSION['cart'])) {
             foreach ($_SESSION['cart'] as $key => $value) {
               ...
               <!-- <td>".$value['id']."</td> -->
                 ...
                 <td>
                   <a href='tes.php?action=remove&id=".$value['id']."'>
             ...
             <td>
                 <a href='tes.php?action=clearall'>
